...
.show_book{border: 1px solid #ccc; margin: 50px 20%}
	...
	.show_detail{margin-top: 30px; line-height: 40px;}
		.show_title{}
		.show_author{}
		.show_press{}
...
<div class='show_book'>
	...
	<div class='show_detail'>
		<span class='show_title'><!-- 这里放书名 -->算法导论</span><br>
		<span class='show_author'><!-- 这里是作者 -->张济</span><br>
		<span class='show_press'><!-- 这里是出版社 -->213出版社</span><br>
		<textarea class='show_introduction' readonly>这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书这是一本好书
		</textarea><br>
		<span class='lend_times'>已被借过<span><!-- 这里写个数字 -->0</span>次了</span>
		<input type='button' class='is_cool' value='赞'/>（<span class='times_of_coll'>0</span>）
		<input type='button' class='is_shit' value='踩'/>（<span class='times_of_shit'>0</span>）<br>
		状态：<span class='state'>已借出</span>
